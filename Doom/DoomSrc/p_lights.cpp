...
void P_SpawnFireFlicker(sector_t*	sector)
{
	...
	flick = reinterpret_cast<fireflicker_t*>(Z_Malloc(sizeof(*flick), PU_LEVSPEC, 0));
...
void P_SpawnLightFlash(sector_t*	sector)
{
	...
	flash = reinterpret_cast<lightflash_t*>(Z_Malloc(sizeof(*flash), PU_LEVSPEC, 0));
...
int		inSync)
{
	...
	flash = reinterpret_cast<strobe_t*>(Z_Malloc(sizeof(*flash), PU_LEVSPEC, 0));
...
void P_SpawnGlowingLight(sector_t*	sector)
{
	...
	g = reinterpret_cast<glow_t*>(Z_Malloc(sizeof(*g), PU_LEVSPEC, 0));
