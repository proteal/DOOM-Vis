...
//
void R_InitSpriteDefs(char** namelist, int namelistLen)
{
	int		i;
	int		l;
	int		intname;
...
//
void R_InitSprites(char** namelist, int namelistLen)
{
	int		i;
	...
	R_InitSpriteDefs(namelist, namelistLen);
}
