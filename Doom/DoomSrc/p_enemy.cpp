...
(void* p1, void*)
{
	player_t*	player = reinterpret_cast<player_t*>(p1);
...
{
	player_t*	player = reinterpret_cast<player_t*>(p1);
	pspdef_t*	psp = reinterpret_cast<pspdef_t*>(p2);
